...
#define GFL_VERSION  "3.10"
#define GFL_VERSION_ 0x0310
...
extern GFLEXTERN void GFLAPI gflGetExtraInfos( const GFL_FILE_INFORMATION* info, int idx, char** name, char** value ); 
